        ...
        <div class="body">
            ...
            <div class="bot">
                <div class="aline">
                    ...
                    <span class="spantwo">${networkPI.name}</span>
                    <span class="spanone">相关活动:</span>
                    <span class="spantwo">${networkPI.actives}</span>
                </div>
                <div class="line"></div>
                <div class="aline">
                    <span class="spanone">组成:</span>
                    <span class="spantwo">${networkPI.compose}</span>
                    <span class="spanone">志愿者精神:</span>
                    <span class="spantwo">${networkPI.spirit}</span>
                </div>
                <div class="line"></div>
                <div class="aline">
                    <span class="spanone">属性:</span>
                    <span class="spantwo">${networkPI.attribute}</span>
                </div>
            </div>
        </div>
    </div>
