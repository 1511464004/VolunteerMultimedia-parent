            ...
            <div id="search_div">
                <form name="search_form" id="sform" action="" method="get">
                    ...
                    <div class="list_top clearfix">
                        <div class="l"><form action="/web/toAppVEnlist.html">&nbsp;
                    ...
                    <c:forEach var="va" items="${vActivityList}">
                        <li class="clearfix">
                            <div class="listimg listimg_opp">
                                ...
                                <a href="/volunteerApp/toAdda/toAdda.html?a_id=${va.id}&v_id=${volunteer.id}" title="${va.name}" target="_blank"
...
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="/volunteerApp/toAdda.html?a_id=${va.id}&v_id=${volunteer.id}" title="文明交通志愿活动" target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="" title="文明交通志愿活动"--%>
<%--                                                 target="_blank">文明交通志愿活动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 40 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>

<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:81px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>35%</span>--%>
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>1 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="汪甸瑶族乡伟弄村控辍保学劝返动员志愿服务活动"--%>
<%--                               target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href=""--%>
<%--                                                 title="汪甸瑶族乡伟弄村控辍保学劝返动员志愿服务活动" target="_blank">汪甸瑶族乡伟弄村控辍保学劝返动员志愿服务活动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 40 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>
...
<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:136px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>59%</span>--%>
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>38 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="文峰区环卫中心环卫所“文明交通”志愿服务活动"--%>
<%--                               target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href=""--%>
<%--                                                 title="文峰区环卫中心环卫所“文明交通”志愿服务活动" target="_blank">文峰区环卫中心环卫所“文明交通”志愿服务活动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 8 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>

<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:14px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>6%</span>--%>
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>1 天--%>
<%--                                </span>--%>
...
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="潘铁营村“我为党旗增光辉”志愿服务活动" target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href=""--%>
<%--                                                 title="潘铁营村“我为党旗增光辉”志愿服务活动" target="_blank">潘铁营村“我为党旗增光辉”志愿服务活动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 300 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>

<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:178px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>77%</span>--%>
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>2 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="东川区文明交通劝导志愿服务活动2" target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="/app/opp/view.php?id=cEpirDGU9mMKi" title="东川区文明交通劝导志愿服务活动2"--%>
<%--                                                 target="_blank">东川区文明交通劝导志愿服务活动2</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 200 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>

<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:3px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>1%</span>--%>
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>27 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="新酢坊社区疫情防控宣传" target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="/app/opp/view.php?id=SqvMwxSKIqppL" title="新酢坊社区疫情防控宣传"--%>
<%--                                                 target="_blank">新酢坊社区疫情防控宣传</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 10 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>

<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:230px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>100%</span>--%>
<%--                            <span class="l">报名人数<br>10</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="orange">项目已结束</font>0 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="护河行动" target="_blank">--%>
<%--                                <img src="/statics/images/111.png">--%>
<%--                            </a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="" title="护河行动"--%>
<%--                                                 target="_blank">护河行动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 100 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>
...
<%--                            <span class="l">报名人数<br>0</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>342 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
<%--                    <li class="clearfix">--%>
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="捡拾小烟头，美化大环境" target="_blank"--%>
<%--                            ><img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="/app/opp/view.php?id=Muhk9XVZ3ajPx" title="捡拾小烟头，美化大环境"--%>
<%--                                                 target="_blank">捡拾小烟头，美化大环境</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 73 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>
...
<%--                        <div class="listimg listimg_opp">--%>
<%--                            <div style="background:#BEBEBE;color:#fff;;">2021-11-23</div>--%>
<%--                            <a href="add.html" title="清洁家园志愿服务活动" target="_blank"--%>
<%--                            > <img src="/statics/images/111.png"></a>--%>
<%--                        </div>--%>
<%--                        <div class="listtxt">--%>
<%--                            <p class="ptitle"><a href="/app/opp/view.php?id=AaNJSEoNQx2HJ" title="清洁家园志愿服务活动"--%>
<%--                                                 target="_blank">清洁家园志愿服务活动</a></p>--%>
<%--                            <p class="popp clearfix"><span class="l">目标：1 岗位 40 人</span>--%>
<%--                                <span class="r opp_time_state" style="background:green">招募中</span>--%>
<%--                            </p>--%>
...
<%--                        </div>--%>
<%--                        <div class="percent1">--%>
<%--                            <div class="percent2" style="width:5px;"></div>--%>
<%--                        </div>--%>
<%--                        <p class="prank clearfix" style="margin-top:0;border-top:0;">--%>
<%--                            <span class="l">项目进度<br>2%</span>--%>
<%--                            <span class="l">报名人数<br>1</span>--%>
<%--                            <span class="l">--%>
<%--                                    <font color="#c30">离招募结束</font><br>18 天--%>
<%--                                </span>--%>
<%--                        </p>--%>
<%--                    </li>--%>
                </ul>
