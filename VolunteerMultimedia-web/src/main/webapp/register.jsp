                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-form-item login-btn">
                                    <div class="layui-input-block">
                                        <button class="layui-btn" style="background-color: #EB0012" lay-submit lay-filter="register">提交</button>
                                    </div>
                                </div>
                            </div>
    ...
    layui.use(["form","element","carousel"], function () {
        ...
        $("#mNickname").blur(function () {
            ...
            if(loginName.length > 0){
                $.get("/volunteer/checkName",{"loginName":loginName},function(result){
                    if(result.exist){
        ...
        form.on("submit(register)",function (data) {
            if(flag){
                ...
                //发送请求
                $.post("/volunteer/register",data.field,function(result){
                    if(result.success){
